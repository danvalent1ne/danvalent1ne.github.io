...
<figure>
    <img src="../images/w18_maps.pdf" style="width:750px;height:auto;"
...
<figure>
    <img src="../images/ariel_emm_survey_param_space.pdf" style="width:750px;height:auto;"
...
mapped in latitude because there is a limited parameter space in which we are capable of observing such signals. Latitudinal hotspot offsets can be
...
using a unique observing strategy designed to give the best constraints on both its longitudinal and latitudinal profile. This will allow us to construct
the most informative eclipse map of an exoplanet to date, from which we will be able to extract a wealth of information, including the atmospheric
dynamics, heat redistribution, wind speeds, and magnetic field geometry.